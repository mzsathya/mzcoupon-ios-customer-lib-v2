...
@property (nonatomic, strong) NSString *daily_coupon_rpt;
@property (nonatomic, strong) NSString *mail_remark;
@property (nonatomic, strong) NSString *mailreply_to;
@property (nonatomic, strong) NSString *merchant_category;
